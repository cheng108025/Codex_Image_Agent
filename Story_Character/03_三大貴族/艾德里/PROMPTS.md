...
| 編號 | 確切檔名 |
| --- | --- |
| 01 | 01-adri-front-fullbody.png |
| 02 | 02-adri-four-view-master.png |
| 03 | 03-adri-expression-sheet.png |
| 04 | 04-adri-costume-detail-sheet.png |
| 05 | 05-adri-color-material-sheet.png |
| 06 | 06-adri-prop-construction-sheet.png |
| 07 | 07-adri-body-reference-sheet.png |

第一階段只生成 01-adri-front-fullbody.png，生成後停止等待使用者核准。核准後才逐次生成下一張；每次仍只生成一張。
...
Canonical character facts (do not add or contradict): Duke Edri habitually wears an elegant smile and leads the Iris family. His story wardrobe has two separate contexts: luxurious noble clothing, or refined understated dark hunting clothes for reconnaissance. Keep the current package to one locked costume version and do not merge the two. The story does not lock his hair, eye color, age, or body metrics.
