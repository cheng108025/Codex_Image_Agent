...
> Tier 配角 — 安德烈之女。本檔為文字版身份規格（範本 v2 FULL package），供 `00-cecilia-character-identity-anchor.png` 與 01–10 全套參考圖生成／校對之依據。
...
- 飾品：貴族胸飾、可佩家紋小徽（`DESIGN-PROPOSAL`）。**00–05 與 10 一律不出現**
- 隨身道具：無（`DESIGN-PROPOSAL`）
- 翅膀／角／尾巴／其他特殊構造：無（人類角色）— **N/A**
- 配戴或連接方式：胸飾別於領口或胸前（僅 09／服裝細節表示意）（`DESIGN-PROPOSAL`）
...
- 不可出現的性別：男性
- **不可出現的姿態**：雙手於身前交握不得出現於任何 A-pose 全身圖（00、01–05、07、10）；不安遲疑僅由臉部神情傳達
