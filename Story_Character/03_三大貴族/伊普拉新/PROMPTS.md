...
| 編號 | 確切檔名 |
| --- | --- |
| 01 | 01-ipranshin-front-fullbody.png |
| 02 | 02-ipranshin-four-view-master.png |
| 03 | 03-ipranshin-expression-sheet.png |
| 04 | 04-ipranshin-costume-detail-sheet.png |
| 05 | 05-ipranshin-color-material-sheet.png |
| 06 | 06-ipranshin-prop-construction-sheet.png |
| 07 | 07-ipranshin-body-reference-sheet.png |

第一階段只生成 01-ipranshin-front-fullbody.png，生成後停止等待使用者核准。核准後才逐次生成下一張；每次仍只生成一張。
...
Canonical character facts (do not add or contradict): Iprashin appears silently in shadow as Andre's secret executor or ally and is ordered to bring in "reinforcements." Identity, faction, appearance, costume, body metrics, and the nature of the reinforcements are all PENDING-USER-INPUT. Do not turn concealment into a canon face, species, power, insignia, or equipment design.
