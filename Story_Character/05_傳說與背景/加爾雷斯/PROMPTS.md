...
| 編號 | 確切檔名 |
| --- | --- |
| 01 | 01-galreth-front-fullbody.png |
| 02 | 02-galreth-four-view-master.png |
| 03 | 03-galreth-expression-sheet.png |
| 04 | 04-galreth-costume-detail-sheet.png |
| 05 | 05-galreth-color-material-sheet.png |
| 06 | 06-galreth-prop-construction-sheet.png |
| 07 | 07-galreth-body-reference-sheet.png |

第一階段只生成 01-galreth-front-fullbody.png，生成後停止等待使用者核准。核准後才逐次生成下一張；每次仍只生成一張。
...
Canonical character facts (do not add or contradict): Gallares is an advance-party member and senior Hector officer who fights alongside Lucan and Montgomery against the mysterious impostor. The story does not state a stable face, hair color, eye color, age, body measurements, weapon, or costume. Existing visual specifics remain DESIGN-PROPOSAL; do not label them CANON.
