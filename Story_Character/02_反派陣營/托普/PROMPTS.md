...
### (a) Exact filenames
- [ ] 01-top-front-fullbody.png — PENDING-GENERATION
- [ ] 02-top-four-view-master.png — PENDING-GENERATION
- [ ] 03-top-expression-sheet.png — PENDING-GENERATION
- [ ] 04-top-costume-detail-sheet.png — PENDING-GENERATION
- [ ] 05-top-color-material-sheet.png — PENDING-GENERATION
- [ ] 06-top-prop-construction-sheet.png — PENDING-GENERATION
- [ ] 07-top-body-reference-sheet.png — PENDING-GENERATION

### (b) Character gate

Generate only 01-top-front-fullbody.png first. Present that single image and stop. Generate the remaining sheets only after explicit user approval of 01. Other characters do not change this character's gate.
...
For 02–07, additionally use ./01-top-front-fullbody.png as this character's identity reference while retaining all three fixed style images.
...
Positive prompt:
Full-body front view, face or head clearly visible and identifiable. Standard neutral A-pose: standing upright, feet shoulder-width apart, arms straight and relaxed at approximately 30-45 degrees away from the body, palms open with fingers slightly spread, no action pose, no contrapposto, no T-pose. Character and costume only, no weapons or props of any kind. Orthographic front camera, flat light-gray background, even shadowless studio light, entire body inside frame. 托普. CANON: elderly man in a simple standard military uniform; DESIGN-PROPOSAL: white-gray cropped hair, amber-brown eyes, deeply lined square face and medium skin. Body metrics: 170 cm; 7.25 heads; shoulders 2.3 head widths; compact elderly build; bilateral symmetry. Costume: CANON: plain regulation uniform; DESIGN-PROPOSAL: muted northern-gray coat, sand-colored sash, dark boots and concealed light armor. Fixed palette: northern gray #555D64; sand #A89068; charcoal #292D31; dull steel #7D878E; medium skin #B78D70; white-gray hair #B8B7B0; amber eyes #946B35. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
## 04 — 04-top-costume-detail-sheet.png
...
Positive prompt:
Costume construction sheet with front and back garment breakdowns, detached outer-layer panels, seam and fastening callouts shown visually without readable text, plus one torso view without the outer layer for 3D body contour reference. No weapons. 托普. CANON: elderly man in a simple standard military uniform; DESIGN-PROPOSAL: white-gray cropped hair, amber-brown eyes, deeply lined square face and medium skin. Body metrics: 170 cm; 7.25 heads; shoulders 2.3 head widths; compact elderly build; bilateral symmetry. Costume: CANON: plain regulation uniform; DESIGN-PROPOSAL: muted northern-gray coat, sand-colored sash, dark boots and concealed light armor. Fixed palette: northern gray #555D64; sand #A89068; charcoal #292D31; dull steel #7D878E; medium skin #B78D70; white-gray hair #B8B7B0; amber eyes #946B35. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, extra fingers, six fingers, too many fingers, fused fingers, missing fingers, duplicated thumbs, malformed hands, extra toes, missing toes

## 05 — 05-top-color-material-sheet.png
...
Positive prompt:
Color and material reference sheet: clean color swatches and material spheres corresponding exactly to northern gray #555D64; sand #A89068; charcoal #292D31; dull steel #7D878E; medium skin #B78D70; white-gray hair #B8B7B0; amber eyes #946B35, plus one small neutral full-body reference in the same identity and pose. No weapons or loose props. Flat neutral lighting. 托普. CANON: elderly man in a simple standard military uniform; DESIGN-PROPOSAL: white-gray cropped hair, amber-brown eyes, deeply lined square face and medium skin. Body metrics: 170 cm; 7.25 heads; shoulders 2.3 head widths; compact elderly build; bilateral symmetry. Costume: CANON: plain regulation uniform; DESIGN-PROPOSAL: muted northern-gray coat, sand-colored sash, dark boots and concealed light armor. Fixed palette: northern gray #555D64; sand #A89068; charcoal #292D31; dull steel #7D878E; medium skin #B78D70; white-gray hair #B8B7B0; amber eyes #946B35. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, extra fingers, six fingers, too many fingers, fused fingers, missing fingers, duplicated thumbs, malformed hands, extra toes, missing toes

## 06 — 06-top-prop-construction-sheet.png
...
Positive prompt:
Props-only construction sheet for 托普: TRAILER CANON: terrain-to-sand ability and restraint apparatus; DESIGN-PROPOSAL: control rings, only in sheet 06. Show front, side and exploded construction views of every documented prop and detachable fitting. No full-body person, no face, no character silhouette; a headless tailor mannequin is permitted only for attachment placement.
...
## 07 — 07-top-body-reference-sheet.png
...
PENDING-USER-INPUT: formal English spelling may not be top; ability construction details remain intentionally unrevealed.

## Instruction for Codex

Read <repo-root>/Story_Character/02_反派陣營/托普/CHARACTER_SPEC.md and this PROMPTS.md. Follow the generation gate. Generate exactly one image per user request, begin with 01-top-front-fullbody.png, present it and stop for approval.