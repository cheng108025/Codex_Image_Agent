...
### (a) Exact filenames
- [ ] 01-chaos-dragon-front-fullbody.png — PENDING-GENERATION
- [ ] 02-chaos-dragon-four-view-master.png — PENDING-GENERATION
- [ ] 03-chaos-dragon-expression-sheet.png — PENDING-GENERATION
- [ ] 04-chaos-dragon-costume-detail-sheet.png — PENDING-GENERATION
- [ ] 05-chaos-dragon-color-material-sheet.png — PENDING-GENERATION
- [ ] 06-chaos-dragon-prop-construction-sheet.png — PENDING-GENERATION

### (b) Character gate

Generate only 01-chaos-dragon-front-fullbody.png first. Present that single image and stop. Generate the remaining sheets only after explicit user approval of 01. Other characters do not change this character's gate.
...
For 02–06, additionally use ./01-chaos-dragon-front-fullbody.png as this character's identity reference while retaining all three fixed style images.
...
## 01 — 01-chaos-dragon-front-fullbody.png
...
Positive prompt:
Full-body front view, face or head clearly visible and identifiable. Natural neutral species-appropriate standing pose, full weight balanced, all feet visible, no action, attack, flight or rearing pose, no handheld or loose props. Orthographic front camera, flat light-gray background, even shadowless studio light, entire body inside frame. 巨龍. CANON: giant dragon independently acts, is controlled by Adama, later loses control and dies; DESIGN-PROPOSAL: black basalt scales, crimson membrane wings, six backward horns and amber-red eyes. Body metrics: approximately 18 m long; shoulder height 5.5 m; wingspan 24 m; massive quadrupedal-draconic frame; bilateral symmetry with battle damage allowed. Costume: DESIGN-PROPOSAL: no clothing; segmented armored scale plates, scarred wing membranes and control harness attachment points. Fixed palette: basalt #17191C; charcoal scale #2D3034; crimson membrane #6D2028; horn ivory #B6AA92; ember eye #E05A2D; control silver #A8B1BA.
...
## 04 — 04-chaos-dragon-costume-detail-sheet.png
...
Positive prompt:
Costume construction sheet with front and back garment breakdowns, detached outer-layer panels, seam and fastening callouts shown visually without readable text, plus one torso view without the outer layer for 3D body contour reference. No weapons. 巨龍. CANON: giant dragon independently acts, is controlled by Adama, later loses control and dies; DESIGN-PROPOSAL: black basalt scales, crimson membrane wings, six backward horns and amber-red eyes. Body metrics: approximately 18 m long; shoulder height 5.5 m; wingspan 24 m; massive quadrupedal-draconic frame; bilateral symmetry with battle damage allowed. Costume: DESIGN-PROPOSAL: no clothing; segmented armored scale plates, scarred wing membranes and control harness attachment points. Fixed palette: basalt #17191C; charcoal scale #2D3034; crimson membrane #6D2028; horn ivory #B6AA92; ember eye #E05A2D; control silver #A8B1BA.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, duplicated limbs, extra wings, extra tail, extra horns, malformed species anatomy

## 05 — 05-chaos-dragon-color-material-sheet.png
...
Positive prompt:
Color and material reference sheet: clean color swatches and material spheres corresponding exactly to basalt #17191C; charcoal scale #2D3034; crimson membrane #6D2028; horn ivory #B6AA92; ember eye #E05A2D; control silver #A8B1BA, plus one small neutral full-body reference in the same identity and pose. No weapons or loose props. Flat neutral lighting. 巨龍. CANON: giant dragon independently acts, is controlled by Adama, later loses control and dies; DESIGN-PROPOSAL: black basalt scales, crimson membrane wings, six backward horns and amber-red eyes. Body metrics: approximately 18 m long; shoulder height 5.5 m; wingspan 24 m; massive quadrupedal-draconic frame; bilateral symmetry with battle damage allowed. Costume: DESIGN-PROPOSAL: no clothing; segmented armored scale plates, scarred wing membranes and control harness attachment points. Fixed palette: basalt #17191C; charcoal scale #2D3034; crimson membrane #6D2028; horn ivory #B6AA92; ember eye #E05A2D; control silver #A8B1BA.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, duplicated limbs, extra wings, extra tail, extra horns, malformed species anatomy

## 06 — 06-chaos-dragon-prop-construction-sheet.png
...
Positive prompt:
Props-only construction sheet for 巨龍: CANON: Adama control device interface; DESIGN-PROPOSAL: broken harness and restraint rings, only in sheet 06. Show front, side and exploded construction views of every documented prop and detachable fitting. No full-body person, no face, no character silhouette; a headless tailor mannequin is permitted only for attachment placement.
...
PENDING-USER-INPUT: whether the trailer dragon and the table's chaos dragon are the same named individual, and its intelligence level, remain unresolved.

## Instruction for Codex

Read <repo-root>/Story_Character/02_反派陣營/巨龍/CHARACTER_SPEC.md and this PROMPTS.md. Follow the generation gate. Generate exactly one image per user request, begin with 01-chaos-dragon-front-fullbody.png, present it and stop for approval.