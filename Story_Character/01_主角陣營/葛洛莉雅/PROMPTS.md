...
### (a) Exact filenames
- [ ] 01-gloria-front-fullbody.png — PENDING-GENERATION
- [ ] 02-gloria-four-view-master.png — PENDING-GENERATION
- [ ] 03-gloria-expression-sheet.png — PENDING-GENERATION
- [ ] 04-gloria-costume-detail-sheet.png — PENDING-GENERATION
- [ ] 05-gloria-color-material-sheet.png — PENDING-GENERATION
- [ ] 06-gloria-prop-construction-sheet.png — PENDING-GENERATION
- [ ] 07-gloria-body-reference-sheet.png — PENDING-GENERATION

### (b) Character gate

Generate only 01-gloria-front-fullbody.png first. Present that single image and stop. Generate the remaining sheets only after explicit user approval of 01. Other characters do not change this character's gate.
...
For 02–07, additionally use ./01-gloria-front-fullbody.png as this character's identity reference while retaining all three fixed style images.
...
## 01 — 01-gloria-front-fullbody.png
...
Positive prompt:
Full-body front view, face or head clearly visible and identifiable. Standard neutral A-pose: standing upright, feet shoulder-width apart, arms straight and relaxed at approximately 30-45 degrees away from the body, palms open with fingers slightly spread, no action pose, no contrapposto, no T-pose. Character and costume only, no weapons or props of any kind. Orthographic front camera, flat light-gray background, even shadowless studio light, entire body inside frame. 葛洛莉雅. CANON: silver-purple hair that can appear pink-white in sunlight, clean fair face, large lively water-violet eyes, noble bearing. Body metrics: 166 cm; 7.35 heads; shoulders 2.1 head widths; graceful educated build; bilateral symmetry. Costume: DESIGN-PROPOSAL: fitted ivory-and-lilac noble dress adapted for political work, short shoulder cape, modest gold trim and soft boots. Fixed palette: ivory #F1ECE1; silver lilac #B9A4C9; water violet #8E75B8; pale gold #C9AE71; fair skin #EEC9B4; silver-purple hair #B6A5BD; violet eyes #8A72B5. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
## 04 — 04-gloria-costume-detail-sheet.png
...
Positive prompt:
Costume construction sheet with front and back garment breakdowns, detached outer-layer panels, seam and fastening callouts shown visually without readable text, plus one torso view without the outer layer for 3D body contour reference. No weapons. 葛洛莉雅. CANON: silver-purple hair that can appear pink-white in sunlight, clean fair face, large lively water-violet eyes, noble bearing. Body metrics: 166 cm; 7.35 heads; shoulders 2.1 head widths; graceful educated build; bilateral symmetry. Costume: DESIGN-PROPOSAL: fitted ivory-and-lilac noble dress adapted for political work, short shoulder cape, modest gold trim and soft boots. Fixed palette: ivory #F1ECE1; silver lilac #B9A4C9; water violet #8E75B8; pale gold #C9AE71; fair skin #EEC9B4; silver-purple hair #B6A5BD; violet eyes #8A72B5. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, extra fingers, six fingers, too many fingers, fused fingers, missing fingers, duplicated thumbs, malformed hands, extra toes, missing toes

## 05 — 05-gloria-color-material-sheet.png
...
Positive prompt:
Color and material reference sheet: clean color swatches and material spheres corresponding exactly to ivory #F1ECE1; silver lilac #B9A4C9; water violet #8E75B8; pale gold #C9AE71; fair skin #EEC9B4; silver-purple hair #B6A5BD; violet eyes #8A72B5, plus one small neutral full-body reference in the same identity and pose. No weapons or loose props. Flat neutral lighting. 葛洛莉雅. CANON: silver-purple hair that can appear pink-white in sunlight, clean fair face, large lively water-violet eyes, noble bearing. Body metrics: 166 cm; 7.35 heads; shoulders 2.1 head widths; graceful educated build; bilateral symmetry. Costume: DESIGN-PROPOSAL: fitted ivory-and-lilac noble dress adapted for political work, short shoulder cape, modest gold trim and soft boots. Fixed palette: ivory #F1ECE1; silver lilac #B9A4C9; water violet #8E75B8; pale gold #C9AE71; fair skin #EEC9B4; silver-purple hair #B6A5BD; violet eyes #8A72B5. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, extra fingers, six fingers, too many fingers, fused fingers, missing fingers, duplicated thumbs, malformed hands, extra toes, missing toes

## 06 — 06-gloria-prop-construction-sheet.png
...
Positive prompt:
Props-only construction sheet for 葛洛莉雅: CANON: church or intelligence letters; DESIGN-PROPOSAL: family pendant, only in sheet 06. Show front, side and exploded construction views of every documented prop and detachable fitting. No full-body person, no face, no character silhouette; a headless tailor mannequin is permitted only for attachment placement.
...
## 07 — 07-gloria-body-reference-sheet.png
...
PENDING-USER-INPUT: fixed Chinese spelling Gloria variant remains unresolved; use folder spelling for this production pass.

## Instruction for Codex

Read <repo-root>/Story_Character/01_主角陣營/葛洛莉雅/CHARACTER_SPEC.md and this PROMPTS.md. Follow the generation gate. Generate exactly one image per user request, begin with 01-gloria-front-fullbody.png, present it and stop for approval.