...
| 編號 | 確切檔名 |
| --- | --- |
| 01 | 01-albert-front-fullbody.png |
| 02 | 02-albert-four-view-master.png |
| 03 | 03-albert-expression-sheet.png |
| 04 | 04-albert-costume-detail-sheet.png |
| 05 | 05-albert-color-material-sheet.png |
| 06 | 06-albert-prop-construction-sheet.png |
| 07 | 07-albert-body-reference-sheet.png |

第一階段只生成 01-albert-front-fullbody.png，生成後停止等待使用者核准。核准後才逐次生成下一張；每次仍只生成一張。
...
Canonical character facts (do not add or contradict): Albert Haruhurst carries himself upright and straight like a spear. He is one of the ten frontier warriors recruited by Eivis and an important Hector officer. The story does not fully specify his face, hair, eye color, age, weapon, or stable costume; all such existing details remain DESIGN-PROPOSAL and must not be promoted to CANON.
