# 艾維斯 Elvis — Image Generation Prompts（範本 v2 FULL package: 00–10）
...
> **09 道具表待決事項（不阻擋 00–08、10）**：簽名武器仍為大型闊劍／大型戰斧二選一，`CHARACTER_SPEC.md` 已給出推薦（大型闊劍）與理由，但正式定案仍為 `PENDING-USER-INPUT`。**此項僅限縮於 09 道具表段落，00–08、10 之生成與驗收不受影響、不需等待此項決定。**

> **兩階段規則（強制）**：第一階段只生成 `00-elvis-character-identity-anchor.png`（三視圖：A-pose 正面全身＋正面頭肩＋45° 三分之四頭肩，缺一即 REJECT 重生成），生成後停止等待使用者核准。核准後 00 成為 01–10 的 Image 1 身份／服裝唯一正本。三張 style 圖永遠只控制畫風。
...
| 01 | `01-elvis-front-fullbody.png` | 正面全身，A-pose，零道具 |
| 02 | `02-elvis-left-profile-fullbody.png` | 相機位於角色解剖學左側全身（戰疤清晰可見），A-pose，零道具 |
| 03 | `03-elvis-right-profile-fullbody.png` | 相機位於角色解剖學右側全身（鬆脫肩甲扣帶清晰可見），A-pose，零道具 |
| 04 | `04-elvis-back-fullbody.png` | 背面全身，A-pose，零道具 |
...
| 08 | `08-elvis-color-material-sheet.png` | 色票／材質表（已補固定 hex） |
| 09 | `09-elvis-prop-construction-sheet.png` | 道具表：簽名武器（PENDING：闊劍或戰斧，唯一出現位置）＋甲片扣件拆解 |
...
Suggested layout: full-body view on the left ~45% of the canvas, straight-on portrait top-right, three-quarter portrait bottom-right. All three views must have identical facial identity, hairstyle, colors and costume, with the scar consistently on the LEFT and the loose pauldron strap consistently on the RIGHT. The straight-on head-and-shoulders portrait is the facial identity authority for later generations. Character and costume only - no weapons, no handheld items, no standalone props, no belt-worn weapons, scabbards or slung shields.
...
## 01 — `01-elvis-front-fullbody.png`（STAGE 2 — 正面）
...
Identity invariants:
Identical character from Image 1: same rugged weather-beaten face, sun-darkened bronze/tan skin (#C08856), deep-set sharp deep-brown eyes (#3E2A1E), messy unkempt short beard/stubble, messy tousled dark-brown hair (#4A3A2E). The old battle scar is visible on the LEFT side of the face.
...
## 02 — `02-elvis-left-profile-fullbody.png`（STAGE 2 — 相機位於角色解剖學左側；戰疤清晰可見）
...
Primary request:
Render Elvis as ONE full-body view with the camera positioned at the character's anatomical LEFT side (the camera looks directly at the character's left flank; the character's left side faces the lens, showing the old battle scar clearly), true orthographic projection, 90 degrees from the front view, in the same standard neutral A-pose as the front view. The character's head faces exactly 90 degrees toward their own anatomical left, away from the camera's direct line; no head turn back toward the lens.

Identity invariants:
Identical character from Image 1: same rugged face structure seen from this angle with the old battle scar clearly visible across the left brow and cheek, messy tousled dark-brown hair (#4A3A2E), sun-darkened bronze/tan skin (#C08856).

Body metrics:
Height approximately 190 cm. Approximately 7.5 heads tall. Shoulder width approximately 2.6 head-widths. Scar on LEFT face (near side, clearly visible); loose pauldron strap on RIGHT shoulder (far side).

Costume invariants:
Identical attire from Image 1 seen from the anatomical-left camera position: battle-worn steel-grey plate silhouette (#6B6E72), frayed dark cloak (#3B332C), leather bracer and gauntlet (#5C4530), broad loosely fastened belt. NO weapon anywhere.
...
Negative prompt:
photorealistic, 3D render, western comic style, chibi, super-deformed, thick outlines, harsh lineart, sketchy unfinished lines, flat unshaded colors, muddy colors, excessive bloom, dramatic cinematic background, scenery, extreme perspective, fisheye, cropped body, inconsistent anatomy, different face, different hairstyle, costume redesign, random accessories, duplicate character, extra limbs, extra fingers, text, labels, letters, numbers, logo, signature, watermark, jpeg artifacts, low resolution, blurry, wings, horns, tail, crown, slender build, clean-shaven, neat pristine armor, tidy polished plate, scar removed, scar missing, reference character face, copying any style-image character, weapon, sword, broadsword, war-axe, scabbard, sheath, shield, staff, prop object, holding weapon, weapon in hand, hand on sword pommel, arms touching torso, arms pressed against body, contrapposto, action pose, heroic pose, battle stance, T-pose, bent elbows, uneven shoulders, crossed legs, hands on hips, crossed arms, dynamic pose, walking, running, cast shadows, strong highlights, rim light, dramatic lighting, front view, back view, three-quarter view, head turned toward viewer, camera on anatomical right side
...
- The old battle scar must be clearly visible in this view (near-side face).
- No text or watermark. Do not invent missing canonical details.
```

---

## 03 — `03-elvis-right-profile-fullbody.png`（STAGE 2 — 相機位於角色解剖學右側；鬆脫肩甲扣帶清晰可見）
...
Primary request:
Render Elvis as ONE full-body view with the camera positioned at the character's anatomical RIGHT side (the camera looks directly at the character's right flank; the character's right side faces the lens, showing the loose/drooping pauldron strap clearly), true orthographic projection, 90 degrees from the front view, in the same standard neutral A-pose as the front view. The character's head faces exactly 90 degrees toward their own anatomical right, away from the camera's direct line; no head turn back toward the lens. The old battle scar on the far (left) side of the face should read only faintly or be turned away, never mirrored onto this right side.

Identity invariants:
Identical character from Image 1: same rugged face structure seen from this angle, messy tousled dark-brown hair (#4A3A2E), sun-darkened bronze/tan skin (#C08856).

Body metrics:
Height approximately 190 cm. Approximately 7.5 heads tall. Shoulder width approximately 2.6 head-widths. Loose pauldron strap on RIGHT shoulder (near side, clearly visible, drooping); scar remains on the far LEFT side only, never mirrored here.

Costume invariants:
Identical attire from Image 1 seen from the anatomical-right camera position: battle-worn steel-grey plate silhouette (#6B6E72) with the RIGHT pauldron's loose unfastened strap clearly drooping, frayed dark cloak (#3B332C), leather bracer and gauntlet (#5C4530), broad loosely fastened belt. NO weapon anywhere.
...
Negative prompt:
photorealistic, 3D render, western comic style, chibi, super-deformed, thick outlines, harsh lineart, sketchy unfinished lines, flat unshaded colors, muddy colors, excessive bloom, dramatic cinematic background, scenery, extreme perspective, fisheye, cropped body, inconsistent anatomy, different face, different hairstyle, costume redesign, random accessories, duplicate character, extra limbs, extra fingers, text, labels, letters, numbers, logo, signature, watermark, jpeg artifacts, low resolution, blurry, wings, horns, tail, crown, slender build, clean-shaven, neat pristine armor, tidy fully-fastened strap on right shoulder, scar mirrored to right side, reference character face, copying any style-image character, weapon, sword, broadsword, war-axe, scabbard, sheath, shield, staff, prop object, holding weapon, weapon in hand, hand on sword pommel, arms touching torso, arms pressed against body, contrapposto, action pose, heroic pose, battle stance, T-pose, bent elbows, uneven shoulders, crossed legs, hands on hips, crossed arms, dynamic pose, walking, running, cast shadows, strong highlights, rim light, dramatic lighting, front view, back view, three-quarter view, head turned toward viewer, camera on anatomical left side
...
- The loose/drooping right pauldron strap must be clearly visible in this view (near-side shoulder).
- No text or watermark. Do not invent missing canonical details.
```

---

## 04 — `04-elvis-back-fullbody.png`（STAGE 2 — 背面）
...
Primary request:
Render Elvis as ONE full-body BACK view (180 degrees) in true orthographic projection, in the same standard neutral A-pose as the front view. Head faces exactly away from the viewer.

Identity invariants:
Identical character from Image 1: same messy tousled dark-brown hair seen from behind (#4A3A2E), same broad-shouldered heavy muscular build.

Body metrics:
Height approximately 190 cm. Approximately 7.5 heads tall. Shoulder width approximately 2.6 head-widths. The loose right pauldron strap remains visible drooping on the character's right (viewer's left) shoulder from behind.

Costume invariants:
Identical attire from Image 1 seen from behind: worn frayed cloak (#3B332C) covering the back with visible battle-stained fraying at the hem, plate back panel (#6B6E72), the loose right-shoulder pauldron strap drooping, broad belt tied loosely at the back, plate leg armor and heavy leather war boots seen from behind. NO weapon anywhere.
...
Negative prompt:
photorealistic, 3D render, western comic style, chibi, super-deformed, thick outlines, harsh lineart, sketchy unfinished lines, flat unshaded colors, muddy colors, excessive bloom, dramatic cinematic background, scenery, extreme perspective, fisheye, cropped body, inconsistent anatomy, different face, different hairstyle, costume redesign, random accessories, duplicate character, extra limbs, extra fingers, text, labels, letters, numbers, logo, signature, watermark, jpeg artifacts, low resolution, blurry, wings, horns, tail, crown, slender build, neat pristine armor, tidy fully-fastened straps, reference character face, copying any style-image character, weapon, sword, broadsword, war-axe, scabbard, sheath, shield, staff, prop object, holding weapon, weapon in hand, hand on sword pommel, arms touching torso, arms pressed against body, contrapposto, action pose, heroic pose, battle stance, T-pose, bent elbows, uneven shoulders, crossed legs, hands on hips, crossed arms, dynamic pose, walking, running, cast shadows, strong highlights, rim light, dramatic lighting, front view, face visible, profile, three-quarter view
...
## 08 — `08-elvis-color-material-sheet.png`（STAGE 2 — 色票／材質表，已補固定 hex）
...
## 09 — `09-elvis-prop-construction-sheet.png`（STAGE 2 — 道具表：簽名武器待決，唯一出現位置）
...
- [ ] 無任何武器道具出現（09 除外，且 09 之簽名武器選定為 PENDING-USER-INPUT）；平光無投影陰影（06 攝影棚柔光除外）
- [ ] 血緣相似：不適用（無血緣角色）
...
| 01 | 正面、A-pose、正交 |
| 02 | 相機位於解剖學左側、A-pose、正交（不得只寫「朝左」）；戰疤清晰可見 |
| 03 | 相機位於解剖學右側、A-pose、正交（不得只寫「朝右」）；鬆脫肩甲扣帶清晰可見 |
| 04 | 背面、A-pose、正交；鬆脫肩甲扣帶（右肩）從背面仍可辨識 |
| 05 | 順序正面→左→右→背；四視圖同高度、同尺寸、同比例、頭頂線與腳底線水平對齊；戰疤僅在左側可見視圖清楚呈現，鬆脫扣帶僅在右側可見視圖清楚呈現 |
| 06 | 恰好 8 格 4×2、順序正確、只有表情改變 |
| 07 | 磨損披風拆解面板＋無披風軀幹視圖必須存在；鬆脫扣帶等散漫穿法須保留 |
| 08 | 色票方塊與鎖定 hex 完全一致 |
| 09 | 簽名武器（闊劍或戰斧，二選一）唯一出現於此，不得兩者並列為同等主武器；無角色、無臉、無人物剪影 |
