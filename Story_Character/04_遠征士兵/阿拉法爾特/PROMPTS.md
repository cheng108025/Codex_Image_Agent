# 阿拉法爾特·斯洛柏格 Alafart Sloberg — Image Generation Prompts（FULL v2 package: 00–10）

> **用途聲明（必讀）**
> 這套圖片是 **3D 建模參考包（modeling reference pack）**，不是完成的 3D 模型。
> 純 AI img2vid 無法保證跨鏡頭的角色完全一致；正式影片必須先以本參考包建立同一個經核准的 **Blender／VRM 角色模型**，並以該模型作為**唯一角色正本**驅動所有鏡頭。

> **角色版本 ID：`ALAFART-V1-1587-EXPEDITION`**（1587 遠征期制式輕甲版；其他時期／服裝需另立版本，不得混用）

> **兩階段規則（強制）**：第一階段只生成 `00-alafart-character-identity-anchor.png`（三視圖：A-pose 正面全身＋正面頭肩＋45° 三分之四頭肩，缺一即 REJECT 重生成），生成後停止等待使用者核准。核准後 00 成為 01–10 的 Image 1 身份／服裝唯一正本。三張 style 圖永遠只控制畫風。
...
| 編號 | 檔案 | 內容 |
| --- | --- | --- |
| 00 | `00-alafart-character-identity-anchor.png` | 身份母圖：A-pose 正面全身＋正面頭肩＋45° 頭肩，零道具，維持憤怒神情 |
| 01 | `01-alafart-front-fullbody.png` | 正面全身，A-pose，零道具 |
| 02 | `02-alafart-left-profile-fullbody.png` | 相機位於角色解剖學左側全身，A-pose，零道具 |
| 03 | `03-alafart-right-profile-fullbody.png` | 相機位於角色解剖學右側全身，A-pose，零道具 |
| 04 | `04-alafart-back-fullbody.png` | 背面全身，A-pose，零道具 |
| 05 | `05-alafart-four-view-master.png` | 四視圖總表（正面→左→右→背），零道具 |
| 06 | `06-alafart-expression-sheet.png` | 八表情臉部表，4×2 網格 |
| 07 | `07-alafart-costume-detail-sheet.png` | 服裝細節表 |
| 08 | `08-alafart-color-material-sheet.png` | 色票／材質表（已補固定 hex） |
| 09 | `09-alafart-prop-construction-sheet.png` | 道具表：火炬＋短刀（全書唯一出現位置） |
| 10 | `10-alafart-body-reference-sheet.png` | 素體參考圖（SMPL-X／人體擬合用） |

---

## 00 — `00-alafart-character-identity-anchor.png`（STAGE 1 — 只先生成這張，停止等核准）
...
Alafart Sloberg, an ordinary Hector expedition foot-soldier, one of three named decoy soldiers and the oldest of the group, apparent age 30 (locked default), height ~178cm, solid sturdy seasoned-infantry build, approximately seven-heads slender proportions. An angular adult male face with a hard square jaw and short beard / heavy stubble (#1C1A18, locked); very short black cropped hair (#1C1A18, locked); weathered slightly tanned skin (#C99A72); his defining trait is a face of ANGER — deeply furrowed brow, hard glaring dark-brown eyes (#3A2A1E, locked), jaw clenched, the resentment of a man forced to march to his death. Costume (locked): 1587 Hector expedition standard light armor — a padded gambeson (#4A3B2E) under a light leather cuirass (#3C2E24) with a few plain dull-steel accents (#52565C), a padded high collar lined in dark cloth, small light leather or plain-steel shoulder pieces with no ornament, leather bracers and plain gloves, a plain leather belt with no weapon attached (his short dagger is reserved exclusively for the prop-construction sheet), cloth or leather trousers with marching leather boots, a small restrained Hector standard crest on the chest, no cloak. Materials: dark brown-to-charcoal leather, muted dark cloth, dull dark-steel fittings — no gemstones, no gold, no ornament. Character and costume only — no torch, no weapon, no handheld items, no standalone props of any kind anywhere on this sheet.

Body metrics:
Height 178 cm. Approximately 7.0 heads tall (design proportion, solid sturdy build). Shoulder width approximately 2.4 head-widths (the sturdiest of the three named decoy soldiers). Fully symmetric build, no left-right facial or body asymmetry.
...
2. one large straight-on head-and-shoulders portrait carrying his signature angry expression (furrowed brow, hard glare, clenched jaw);
...
Negative prompt:
photorealistic, 3D render, western comic style, chibi, super-deformed, thick outlines, harsh lineart, sketchy unfinished lines, flat unshaded colors, muddy colors, excessive bloom, dramatic cinematic background, scenery, extreme perspective, fisheye, cropped body, inconsistent anatomy, different face, different hairstyle, costume redesign, random accessories, duplicate character, extra limbs, extra fingers, text, labels, letters, numbers, logo, signature, watermark, jpeg artifacts, low resolution, blurry, heavy plate, full plate armor, heavy armor, ornate armor, noble finery, royal regalia, crown, gemstones, gold pauldrons, wings, horns, tail, worshipful expression, adoring gaze, fearful cowering expression, wide frightened eyes, smiling, youthful beardless boyish face, torch, lit flame, held object, holding weapon, weapon in hand, hand on sword pommel, arms touching torso, arms pressed against body, contrapposto, action pose, heroic pose, battle stance, T-pose, bent elbows, uneven shoulders, crossed legs, hands on hips, crossed arms, dynamic pose, walking, running, cast shadows, strong highlights, rim light, dramatic lighting, weapon, sword, scabbard, sheath, staff, shield, prop object, reference character face, copying any style-image character, blending the three reference characters, Kritz black-and-gold pauldrons, shoulder chains, purple gemstones, Revanas ice-crystal horns, crystalline wings

Constraints:
- The three input images control visual style only; do not reproduce or blend their characters.
- Follow all CANON facts exactly (angular bearded adult face, very short black hair, angry furrowed glare, sturdy older build, standard light expedition armor).
...
## 01 — `01-alafart-front-fullbody.png`（STAGE 2 — 正面全身）
...
Input images:
- Image 1: the approved 00-alafart-character-identity-anchor.png and sole identity/costume authority.
- Images 2-4: shared style references only; do not copy their character identities.

Primary request:
Render Alafart as ONE full-body front view (0 degrees) in true orthographic projection, in the standard neutral A-pose: standing upright, feet shoulder-width apart, toes forward, arms straight and relaxed at approximately 30-45 degrees away from the body, palms open with fingers slightly spread and clearly separated, shoulders level, weight evenly distributed, no contrapposto, no action pose, no T-pose. A calm neutral face is acceptable for this orthographic body view.

Identity invariants:
Identical character from Image 1: same angular hard-jawed adult male face with short beard/heavy stubble (#1C1A18), dark-brown eyes (#3A2A1E), very short black cropped hair (#1C1A18), weathered tanned skin (#C99A72).

Body metrics:
Height 178 cm. Approximately 7.0 heads tall. Shoulder width approximately 2.4 head-widths. Fully symmetric design.
...
Negative prompt:
photorealistic, 3D render, western comic style, chibi, super-deformed, thick outlines, harsh lineart, sketchy unfinished lines, flat unshaded colors, muddy colors, excessive bloom, dramatic cinematic background, scenery, extreme perspective, fisheye, cropped body, inconsistent anatomy, different face, different hairstyle, costume redesign, random accessories, duplicate character, extra limbs, extra fingers, text, labels, letters, numbers, logo, signature, watermark, jpeg artifacts, low resolution, blurry, heavy plate, ornate armor, gemstones, gold pauldrons, wings, horns, tail, beardless youthful face, torch, holding weapon, weapon in hand, weapon, sword, scabbard, sheath, staff, shield, prop object, reference character face, copying any style-image character, arms touching torso, arms pressed against body, contrapposto, action pose, heroic pose, battle stance, T-pose, bent elbows, uneven shoulders, crossed legs, hands on hips, crossed arms, dynamic pose, walking, running, cast shadows, strong highlights, rim light, dramatic lighting, side view, profile, back view, three-quarter view
...
## 02 — `02-alafart-left-profile-fullbody.png`（STAGE 2 — 相機位於角色解剖學左側）
...
## 03 — `03-alafart-right-profile-fullbody.png`（STAGE 2 — 相機位於角色解剖學右側）
...
## 04 — `04-alafart-back-fullbody.png`（STAGE 2 — 背面全身）
...
## 05 — `05-alafart-four-view-master.png`（STAGE 2 — 四視圖總表）
...
Negative prompt:
photorealistic, 3D render, western comic style, chibi, super-deformed, thick outlines, harsh lineart, sketchy unfinished lines, flat unshaded colors, muddy colors, excessive bloom, dramatic cinematic background, scenery, extreme perspective, fisheye, cropped body, inconsistent anatomy, different face, different hairstyle, costume redesign, random accessories, duplicate character, extra limbs, extra fingers, text, labels, letters, numbers, logo, signature, watermark, jpeg artifacts, low resolution, blurry, heavy plate, ornate armor, gemstones, gold pauldrons, wings, horns, tail, beardless youthful face, inconsistent scale between views, different height per view, mismatched costume between views, torch, holding weapon, weapon in hand, weapon, sword, scabbard, sheath, staff, shield, prop object, contrapposto, action pose, T-pose, bent elbows, uneven shoulders, crossed legs, hands on hips, crossed arms, dynamic pose, walking, running, cast shadows, strong highlights, rim light, dramatic lighting, reference character face, copying any style-image character
...
## 06 — `06-alafart-expression-sheet.png`（STAGE 2 — 八表情臉部表）
...
Input images:
- Image 1: use only as the character identity, hairstyle, beard, costume-collar and color reference (the approved 00-alafart-character-identity-anchor.png). Ignore its original pose, framing and composition.
- Images 2-4: shared visual-style references only. Do not copy their character identities, faces, hairstyles, costumes or anatomy.

Primary request:
Recompose Alafart into standardized head-and-shoulders studio portraits. Create exactly eight portraits arranged neatly in a 4-column by 2-row grid on a pure white seamless background. Every portrait must use a straight-on front view at 0 degrees. Crop from just below the collarbones to slightly above the top of the hair. The head must occupy approximately 70-75 percent of each panel.

Identity invariants:
Keep exactly the same character in all eight portraits. Preserve the identical facial identity, angular hard-jawed face proportions, short beard/heavy stubble (#1C1A18), weathered tanned skin (#C99A72), dark-brown eyes (#3A2A1E), very short black cropped hair (#1C1A18), neck proportions, and the visible padded high collar. Use the same framing, camera distance, head size, lighting, color grading and front-facing angle in every panel. Only the facial expression may change; his baseline (neutral panel) still carries a residue of resentment.
...
Primary request:
Create a professional costume construction sheet for Alafart's standard light expedition armor, organized as callout panels on one sheet:
...
## 08 — `08-alafart-color-material-sheet.png`（STAGE 2 — 色票／材質表，已補固定 hex）
...
Primary request:
Create a production color-and-material sheet for Alafart: a medium-size neutral A-pose front figure (character and costume only, no weapon or torch) on the left, and on the right a column of large clean color swatches with material rendering patches for each locked color:
...
- weathered tanned skin #C99A72
- black hair and beard/stubble #1C1A18
- dark-brown eyes #3A2A1E
...
Identity invariants:
The reference figure is the identical character from Image 1; same face, hair, proportions (178 cm, 7.0 heads, solid sturdy build).
...
## 09 — `09-alafart-prop-construction-sheet.png`（STAGE 2 — 道具表：火炬與短刀，全書唯一出現位置）
...
Input images:
- Image 1: the approved 00-alafart-character-identity-anchor.png — use ONLY to match material language and craftsmanship level; do not depict the character.
- Images 2-4: shared style references only; do not copy their characters.

Primary request:
Create a props-only construction sheet for Alafart's two items:
...
## 10 — `10-alafart-body-reference-sheet.png`（STAGE 2 — 素體參考圖，SMPL-X／人體擬合用）
...
Input images:
- Image 1: the approved 00-alafart-character-identity-anchor.png and sole identity authority (face, hair, skin tone, body proportions).
- Images 2-4: shared style references only; do not copy their character identities.

Primary request:
Render Alafart WITHOUT armor or any outer garment — wearing only a plain tight dark-gray bodysuit (form-fitting underlayer, no folds, no accessories) — as TWO full-body views on one sheet: straight-on FRONT view and LEFT profile view. Both views in the exact same standard neutral A-pose: standing upright, feet shoulder-width apart, arms straight and relaxed at approximately 30-45 degrees away from the body, palms open with fingers slightly spread and clearly separated, shoulders level, weight evenly distributed, true orthographic projection, no contrapposto, no action pose, no T-pose. The body silhouette must be fully visible and unobstructed: no armor, no loose clothing; the short hair must not cover the neck or shoulder outline. A calm neutral face is acceptable for this body-reference sheet.

Identity invariants:
Same character as Image 1: same face, very short black cropped hair (#1C1A18), short beard/heavy stubble (#1C1A18), weathered tanned skin (#C99A72), dark-brown eyes (#3A2A1E). The body underneath must be consistent with the armored figure of the approved sheets: solid, sturdy, seasoned-infantry build.

Body metrics:
Height 178 cm. Approximately 7.0 heads tall. Shoulder width approximately 2.4 head-widths. Identical height and proportions in both views; head-top and foot lines horizontally aligned across the two views.
...
- [ ] 髮型、髮色（黑色極短平頭）、鬚型（短鬚／濃鬍渣）一致 #1C1A18
- [ ] 身材比例：178cm／約 7.0 頭身／肩寬約 2.4 倍頭寬、結實粗壯
- [ ] 服裝結構與 Costume Lock 一致（層次、配件數量、位置）
- [ ] 左右位置正確：全對稱設計（00–05／10 零道具無不對稱；09 火炬／短刀慣用側＝右，跨圖一致）
- [ ] 色票未漂移：#3C2E24／#4A3B2E／#52565C／#C99A72／#1C1A18／#3A2A1E／#E8873A（僅 09）
...
| 張 | 額外驗收 |
| --- | --- |
| 00 | 三視圖齊全（A-pose 正面全身＋正面頭肩＋45° 頭肩），缺一即 REJECT；零道具（無火炬、無短刀）；頭肩像維持憤怒神情 |
| 01 | 正面、A-pose、正交 |
