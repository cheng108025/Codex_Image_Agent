# 阿拉法爾特 — Image Generation Prompts
...
> Pair sync ID: alafart-F1B720F99C76
>
> Alafalt is a carpenter and Hector soldier, Eleanor's husband, Robin's father, and Gawain's closest friend in a brother-like bond. He dies in the war. His exact facial features are not fully stated. Preserve family continuity without inventing inherited facial traits; any removable soldier or carpentry equipment appears only on sheet 06.
>
...
| 編號 | 確切檔名 |
| --- | --- |
| 01 | 01-alafart-front-fullbody.png |
| 02 | 02-alafart-four-view-master.png |
| 03 | 03-alafart-expression-sheet.png |
| 04 | 04-alafart-costume-detail-sheet.png |
| 05 | 05-alafart-color-material-sheet.png |
| 06 | 06-alafart-prop-construction-sheet.png |
| 07 | 07-alafart-body-reference-sheet.png |

第一階段只生成 01-alafart-front-fullbody.png，生成後停止等待使用者核准。核准後才逐次生成下一張；每次仍只生成一張。
...
Canonical character facts (do not add or contradict): Alafalt is a carpenter and Hector soldier, Eleanor's husband, Robin's father, and Gawain's closest friend in a brother-like bond. He dies in the war. His exact facial features are not fully stated. Preserve family continuity without inventing inherited facial traits; any removable soldier or carpentry equipment appears only on sheet 06.
