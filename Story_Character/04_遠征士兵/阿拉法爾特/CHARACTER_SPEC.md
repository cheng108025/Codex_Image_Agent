...
- CANON：Alafalt is a carpenter and Hector soldier, Eleanor's husband, Robin's father, and Gawain's closest friend in a brother-like bond. He dies in the war. His exact facial features are not fully stated. Preserve family continuity without inventing inherited facial traits; any removable soldier or carpentry equipment appears only on sheet 06.
...
- Canon 未指定色名；沿用的舊版候選 hex 全部為 DESIGN-PROPOSAL：#3C2E24、#52565C、#E8873A、#4A3B2E、#C99A72、#1C1A18、#3A2A1E
- Canon 色名與候選 hex 發生衝突時：PENDING-USER-INPUT，不得生圖定案。

## 道具與特殊構造

- 只允許 Canon 摘要明載的可拆卸武器、飾品、工具、坐騎裝具或特殊構造。
- 所有可拆卸道具只出現在 06-alafart-prop-construction-sheet.png。
