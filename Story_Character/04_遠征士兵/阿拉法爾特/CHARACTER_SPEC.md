...
> Tier — 配角（遠征誘餌士兵，有名字的犧牲者）。本檔為文字版身份規格（新版七張制 01–07），供 `01-alafart-front-fullbody.png` 與 01–07 全套參考圖生成／校對之依據。
...
## 參考圖片
- 初始角色外觀圖片：無
- 核准後的角色身份正本：`01-alafart-front-fullbody.png`（`PENDING-GENERATION`）
...
7. 悲傷 Sadness
8. 眨眼 Wink
> 註：其標誌性情緒為「憤怒」——被迫赴死的怨怒。01 號頭部基準採「深鎖眉頭、瞪視前方的怒容」為身份標記，與歐文的恐懼、強尼的崇拜區隔。表情表僅改變眉眼與嘴部；臉部身份、黑色極短平頭與短鬚、深褐眼與制式輕甲跨八格一致。
