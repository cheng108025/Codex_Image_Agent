...
### (a) Exact filenames
- [ ] 01-dave-front-fullbody.png — PENDING-GENERATION
- [ ] 02-dave-four-view-master.png — PENDING-GENERATION
- [ ] 03-dave-expression-sheet.png — PENDING-GENERATION
- [ ] 04-dave-costume-detail-sheet.png — PENDING-GENERATION
- [ ] 05-dave-color-material-sheet.png — PENDING-GENERATION
- [ ] 06-dave-prop-construction-sheet.png — PENDING-GENERATION
- [ ] 07-dave-body-reference-sheet.png — PENDING-GENERATION

### (b) Character gate

Generate only 01-dave-front-fullbody.png first. Present that single image and stop. Generate the remaining sheets only after explicit user approval of 01. Other characters do not change this character's gate.
...
For 02–07, additionally use ./01-dave-front-fullbody.png as this character's identity reference while retaining all three fixed style images.
...
Positive prompt:
Full-body front view, face or head clearly visible and identifiable. Standard neutral A-pose: standing upright, feet shoulder-width apart, arms straight and relaxed at approximately 30-45 degrees away from the body, palms open with fingers slightly spread, no action pose, no contrapposto, no T-pose. Character and costume only, no weapons or props of any kind. Orthographic front camera, flat light-gray background, even shadowless studio light, entire body inside frame. 戴夫. TRAILER CANON: surviving expedition soldier who pushes Gawain away from a fatal attack; DESIGN-PROPOSAL: dark blond cropped hair, brown eyes, weathered fair skin and broad calm face. Body metrics: 178 cm; 7.45 heads; shoulders 2.5 head widths; sturdy soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: standard Hector field armor with a muted green scarf, reinforced shoulder plates and heavy boots. Fixed palette: field gray #4A5058; muted green #58634B; leather #654A37; steel #838C94; fair skin #D0A98D; dark blond hair #8A7655; brown eyes #5B4030. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
## 04 — 04-dave-costume-detail-sheet.png
...
Positive prompt:
Costume construction sheet with front and back garment breakdowns, detached outer-layer panels, seam and fastening callouts shown visually without readable text, plus one torso view without the outer layer for 3D body contour reference. No weapons. 戴夫. TRAILER CANON: surviving expedition soldier who pushes Gawain away from a fatal attack; DESIGN-PROPOSAL: dark blond cropped hair, brown eyes, weathered fair skin and broad calm face. Body metrics: 178 cm; 7.45 heads; shoulders 2.5 head widths; sturdy soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: standard Hector field armor with a muted green scarf, reinforced shoulder plates and heavy boots. Fixed palette: field gray #4A5058; muted green #58634B; leather #654A37; steel #838C94; fair skin #D0A98D; dark blond hair #8A7655; brown eyes #5B4030. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, extra fingers, six fingers, too many fingers, fused fingers, missing fingers, duplicated thumbs, malformed hands, extra toes, missing toes

## 05 — 05-dave-color-material-sheet.png
...
Positive prompt:
Color and material reference sheet: clean color swatches and material spheres corresponding exactly to field gray #4A5058; muted green #58634B; leather #654A37; steel #838C94; fair skin #D0A98D; dark blond hair #8A7655; brown eyes #5B4030, plus one small neutral full-body reference in the same identity and pose. No weapons or loose props. Flat neutral lighting. 戴夫. TRAILER CANON: surviving expedition soldier who pushes Gawain away from a fatal attack; DESIGN-PROPOSAL: dark blond cropped hair, brown eyes, weathered fair skin and broad calm face. Body metrics: 178 cm; 7.45 heads; shoulders 2.5 head widths; sturdy soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: standard Hector field armor with a muted green scarf, reinforced shoulder plates and heavy boots. Fixed palette: field gray #4A5058; muted green #58634B; leather #654A37; steel #838C94; fair skin #D0A98D; dark blond hair #8A7655; brown eyes #5B4030. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.

Negative prompt:
identity drift, wrong character, copied reference-person identity, age drift, palette drift, costume redesign, weapon, sword, scabbard, sheath, staff, shield, prop object, holding weapon, action pose, contrapposto, T-pose, cast shadows, strong highlights, rim light, cropped head, cropped feet, perspective distortion, text, watermark, extra fingers, six fingers, too many fingers, fused fingers, missing fingers, duplicated thumbs, malformed hands, extra toes, missing toes

## 06 — 06-dave-prop-construction-sheet.png
...
Positive prompt:
Props-only construction sheet for 戴夫: TRAILER CANON: field weapon not specified; DESIGN-PROPOSAL: spear and battered shield, only in sheet 06. Show front, side and exploded construction views of every documented prop and detachable fitting. No full-body person, no face, no character silhouette; a headless tailor mannequin is permitted only for attachment placement.
...
## 07 — 07-dave-body-reference-sheet.png
...
Read <repo-root>/Story_Character/04_遠征士兵/戴夫/CHARACTER_SPEC.md and this PROMPTS.md. Follow the generation gate. Generate exactly one image per user request, begin with 01-dave-front-fullbody.png, present it and stop for approval.