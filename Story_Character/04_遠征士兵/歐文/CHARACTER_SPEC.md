...
> Tier — 配角（遠征誘餌士兵，有名字的犧牲者）。本檔為文字版身份規格（新版七張制 01–07），供 `01-owen-front-fullbody.png` 與 01–07 全套參考圖生成／校對之依據。
...
## 參考圖片
- 初始角色外觀圖片：無
- 核准後的角色身份正本：`01-owen-front-fullbody.png`（`PENDING-GENERATION`）
...
7. 悲傷 Sadness
8. 眨眼 Wink
> 註：其標誌性情緒為「恐懼」——被念到名字時掩不住的畏懼。01 號頭部基準採「睜大眼、眉頭高聳的恐懼神情」為身份標記，與阿拉法爾特的憤怒、強尼的崇拜區隔。表情表僅改變眉眼與嘴部；臉部身份、深褐色略凌亂短髮、灰褐眼與制式輕甲跨八格一致。
