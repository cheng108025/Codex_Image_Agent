...
### (a) Exact filenames
- [ ] 01-owen-front-fullbody.png — PENDING-GENERATION
- [ ] 02-owen-four-view-master.png — PENDING-GENERATION
- [ ] 03-owen-expression-sheet.png — PENDING-GENERATION
- [ ] 04-owen-costume-detail-sheet.png — PENDING-GENERATION
- [ ] 05-owen-color-material-sheet.png — PENDING-GENERATION
- [ ] 06-owen-prop-construction-sheet.png — PENDING-GENERATION
- [ ] 07-owen-body-reference-sheet.png — PENDING-GENERATION

### (b) Character gate

Generate only 01-owen-front-fullbody.png first. Present that single image and stop. Generate the remaining sheets only after explicit user approval of 01. Other characters do not change this character's gate.
...
For 02–07, additionally use ./01-owen-front-fullbody.png as this character's identity reference while retaining all three fixed style images.
...
Positive prompt:
Full-body front view, face or head clearly visible and identifiable. Standard neutral A-pose: standing upright, feet shoulder-width apart, arms straight and relaxed at approximately 30-45 degrees away from the body, palms open with fingers slightly spread, no action pose, no contrapposto, no T-pose. Character and costume only, no weapons or props of any kind. Orthographic front camera, flat light-gray background, even shadowless studio light, entire body inside frame. 歐文. CANON: blockade guard and Hector member; TRAILER CANON full name Owen Dix; DESIGN-PROPOSAL: ash-black cropped hair, hazel eyes, medium skin and watchful face. Body metrics: 177 cm; 7.45 heads; shoulders 2.35 head widths; practical soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: Hector expedition armor, dark teal scarf, leather utility belt and light boots. Fixed palette: dark teal #31575A; charcoal #343A40; leather #674B39; steel #818A91; medium skin #B7896C; ash hair #4A4748; hazel eyes #7D653C. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
Input images:
- ./01-owen-front-fullbody.png
- ../../style/SV8zdQHTYqQAAAABJRU5ErkJggg.png
- ../../style/McEZ7GwGWkAAAAABJRU5ErkJggg.png
- ../../style/8fJgh1kde6P3IAAAAASUVORK5CYII.png

Positive prompt:
One turnaround sheet with four complete views in this exact order: front, camera on the character's anatomical LEFT side, camera on the character's anatomical RIGHT side, back. Same neutral pose, height, scale and proportions in every panel; true orthographic camera; aligned head-top and ground lines. 歐文. CANON: blockade guard and Hector member; TRAILER CANON full name Owen Dix; DESIGN-PROPOSAL: ash-black cropped hair, hazel eyes, medium skin and watchful face. Body metrics: 177 cm; 7.45 heads; shoulders 2.35 head widths; practical soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: Hector expedition armor, dark teal scarf, leather utility belt and light boots. Fixed palette: dark teal #31575A; charcoal #343A40; leather #674B39; steel #818A91; medium skin #B7896C; ash hair #4A4748; hazel eyes #7D653C. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
Positive prompt:
Eight head-and-shoulders portraits in a 4x2 grid, straight-on 0-degree camera, head occupies 70-75 percent of each cell. Exact order: neutral, gentle smile, broad smile with teeth, joyful open laughter, surprised, angry, sad, wink. Only expression changes. 歐文. CANON: blockade guard and Hector member; TRAILER CANON full name Owen Dix; DESIGN-PROPOSAL: ash-black cropped hair, hazel eyes, medium skin and watchful face. Body metrics: 177 cm; 7.45 heads; shoulders 2.35 head widths; practical soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: Hector expedition armor, dark teal scarf, leather utility belt and light boots. Fixed palette: dark teal #31575A; charcoal #343A40; leather #674B39; steel #818A91; medium skin #B7896C; ash hair #4A4748; hazel eyes #7D653C.
...
Positive prompt:
Costume construction sheet with front and back garment breakdowns, detached outer-layer panels, seam and fastening callouts shown visually without readable text, plus one torso view without the outer layer for 3D body contour reference. No weapons. 歐文. CANON: blockade guard and Hector member; TRAILER CANON full name Owen Dix; DESIGN-PROPOSAL: ash-black cropped hair, hazel eyes, medium skin and watchful face. Body metrics: 177 cm; 7.45 heads; shoulders 2.35 head widths; practical soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: Hector expedition armor, dark teal scarf, leather utility belt and light boots. Fixed palette: dark teal #31575A; charcoal #343A40; leather #674B39; steel #818A91; medium skin #B7896C; ash hair #4A4748; hazel eyes #7D653C. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
Positive prompt:
Color and material reference sheet: clean color swatches and material spheres corresponding exactly to dark teal #31575A; charcoal #343A40; leather #674B39; steel #818A91; medium skin #B7896C; ash hair #4A4748; hazel eyes #7D653C, plus one small neutral full-body reference in the same identity and pose. No weapons or loose props. Flat neutral lighting. 歐文. CANON: blockade guard and Hector member; TRAILER CANON full name Owen Dix; DESIGN-PROPOSAL: ash-black cropped hair, hazel eyes, medium skin and watchful face. Body metrics: 177 cm; 7.45 heads; shoulders 2.35 head widths; practical soldier build; bilateral symmetry. Costume: DESIGN-PROPOSAL: Hector expedition armor, dark teal scarf, leather utility belt and light boots. Fixed palette: dark teal #31575A; charcoal #343A40; leather #674B39; steel #818A91; medium skin #B7896C; ash hair #4A4748; hazel eyes #7D653C. Anatomically correct human hands; exactly five fingers on each hand, one thumb and four fingers, clearly separated natural digits; exactly five toes per foot.
...
Positive prompt:
Props-only construction sheet for 歐文: TRAILER CANON: decoy torch; DESIGN-PROPOSAL: short sword and guard keys, only in sheet 06. Show front, side and exploded construction views of every documented prop and detachable fitting. No full-body person, no face, no character silhouette; a headless tailor mannequin is permitted only for attachment placement.
...
PENDING-USER-INPUT: later fate and fixed appearance are not recorded.

## Instruction for Codex

Read <repo-root>/Story_Character/04_遠征士兵/歐文/CHARACTER_SPEC.md and this PROMPTS.md. Follow the generation gate. Generate exactly one image per user request, begin with 01-owen-front-fullbody.png, present it and stop for approval.